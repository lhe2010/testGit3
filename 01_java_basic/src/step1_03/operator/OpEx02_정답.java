...
public class OpEx02_정답 {
	...
	public static void main(String[] args) {
		...
		System.out.println("월급이 100원일때 연봉은 " + (100*12*0.9) + "원");
		
		//**********************정수/정수=정수!!!!!
		//문제2) 시험점수를 30, 50, 4점 을 받았다. 평균은?
		System.out.println("시험점수를 30, 50, 4점 받았을 때 평균은 " + (30+50+4)/3.0 + "점");

		//**********************정수/정수=정수!!!!!
		//문제3) 가로가 3이고 세로가 6인 삼각형 넓이 출력
		System.out.println("가로가 3이고 세로가 6인 삼각형 넓이는 " + (3*6)/2.0);
		...
		//정답5) 500원(1개), 100원(3개)
		System.out.println("800원에서 500원 개수는 " + 800/500 + "개, 100원 개수는 " + (800%500)/100 + "개");
	}
